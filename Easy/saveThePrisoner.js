...
// treats to pass out to them. Their jailer decides the 
// fairest way to divide the treats is to seat the prisoners 
// around a circular table in sequentially numbered chairs. 
// A chair number will be drawn from a hat. Beginning with the 
